...
define('self-start-front-end/components/add-exercises', ['exports', 'self-start-front-end/utils/file-object'], function (exports, _fileObject) {
  ...
  exports.default = Ember.Component.extend({
    ...
    actions: {
      ...
      addObjective: function addObjective(index) {
...
define('self-start-front-end/components/edit-exercises', ['exports', 'self-start-front-end/utils/file-object'], function (exports, _fileObject) {
  ...
  exports.default = Ember.Component.extend({
    ...
    actions: {
      ...
      openModal: function openModal() {
        ...
        Ember.$('.ui.' + this.get('modalName') + '.modal').modal({
          ...
          onApprove: function onApprove() {
            ...
            // });
            var temp = [];
            _this.get('tempObj').forEach(function (o) {
      ...
      editObjective: function editObjective(name) {
      ...
      deleteObjective: function deleteObjective(o) {
        this.get('tempObj').removeObject(o);
      },
      deleteActionStep: function deleteActionStep(aS) {
...
define('self-start-front-end/controllers/assessment-display', ['exports'], function (exports) {
    'use strict';
...
define('self-start-front-end/routes/assessment-display', ['exports'], function (exports) {
    'use strict';
...
define("self-start-front-end/templates/assessment-display", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "HVcPgRzN", "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[6,\"br\"],[7],[8],[6,\"br\"],[7],[8],[6,\"br\"],[7],[8],[6,\"br\"],[7],[8],[0,\"\\n\\n\"],[1,[25,\"display-assessment\",null,[[\"assessID\"],[[20,[\"id\"]]]]],false]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/assessment-display.hbs" } });
});
...
if (!runningTests) {
  require("self-start-front-end/app")["default"].create({"name":"self-start-front-end","version":"0.0.0+9e29a615"});
}
