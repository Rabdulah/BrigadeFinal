...
define('self-start-front-end/components/client-settings', ['exports'], function (exports) {
  'use strict';
...
if (!runningTests) {
  require("self-start-front-end/app")["default"].create({"name":"self-start-front-end","version":"0.0.0+4c57be5c"});
}
