  ...
  exports.default = Ember.Component.extend({
    ...
    actions: {
      ...
      book_appointment: function book_appointment() {
        ...
        var client = '5ac534f93d763c33cc978c39';
        //desktop
...
define('self-start-front-end/components/display-answers', ['exports'], function (exports) {
  ...
  exports.default = Ember.Component.extend({
    init: function init() {
      ...
      this.get('DS').query('answer', { filter: { 'test': this.get('assessid') } }).then(function (ans) {
        ans.forEach(function (rec) {
          a.pushObject(rec.get('answer'));
        });

        if (_this.get('question').get('type') === "Short answer") {
          _this.set("SAanswer", a[_this.get('qNumber')]);
        }
        if (_this.get('question').get('type') === "Rating") {
          _this.set("Rating", a[_this.get('qNumber')]);
        }
        if (_this.get('question').get('type') === "True/False") {
          if (a[_this.get('qNumber')] === "Yes") {
            _this.set("checkTrue", true);
          } else {
            _this.set("checkFalse", true);
          }
        }
        if (_this.get('question').get('type') === "Multiple choice") {
          var breakdown = _this.get('question').get("optionString").split('+++');
          ...
          if (a[_this.get('qNumber')] === "0") {
            _this.set("checkmcop1", true);
          } else if (a[_this.get('qNumber')] === "1") {
            _this.set("checkmcop2", true);
          } else if (a[_this.get('qNumber')] === "2") {
            _this.set("checkmcop3", true);
          } else if (a[_this.get('qNumber')] === "3") {
            _this.set("checkmcop4", true);
          } else if (a[_this.get('qNumber')] === "4") {
  ...
  exports.default = Ember.Component.extend({
    ...
    activeModel: Ember.observer('onChange', function () {
      ...
      if (this.get('orders')[this.get("onChange")].get('question').get('type') === "Multiple choice") {
        var breakdown = this.get('orders')[this.get("onChange")].get('question').get("optionString").split('+++');
        var length = breakdown.length;
      ...
      if (this.get("onChange") < this.get("model").get("questionOrder").length) this.set("onChange", this.get("onChange") + 1);
      //});
    }),
...
define('self-start-front-end/components/register-user', ['exports'], function (exports) {
  ...
  exports.default = Ember.Component.extend({
    ...
    cities: Ember.observer('province', function () {
      ...
      this.get('DS').query('city', { filter: { 'province': this.get('province') } }).then(function (cities) {

        _this2.get('cityModel').clear();

        cities.forEach(function (rec) {
          _this2.get('cityModel').pushObject(rec);
        });
      });
    }),
    ...
    actions: {
      ...
      submit: function submit() {
        ...
        patient.save().then(function (patient) {
          _this3.get('DS').query('form', { filter: { 'name': 'Intake Form' } }).then(function (intake) {

            var ans = [];

            console.log(intake.get('firstObject'));

            var newTest = _this3.get('DS').createRecord('assessment-test', {
              name: "Intake Form",
            ...
            newTest.save().then(function () {
              ...
              _this3.get('DS').query('question-order', { filter: { 'form': intake.get('firstObject').id } }).then(function (rec) {

                rec.forEach(function (r) {
                  console.log(r.get('question').content.get('questionText'));
                  var answer = _this3.get('DS').createRecord('answer', {
                    question: "",
                    answer: "",
                    test: newTest
                  });
...
define("self-start-front-end/templates/client", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "HBgqv6Xp", "block": "{\"symbols\":[],\"statements\":[[4,\"client-nav\",null,null,{\"statements\":[[1,[18,\"outlet\"],false],[0,\"\\n\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/client.hbs" } });
});
...
define("self-start-front-end/templates/components/client-appointment", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "1sTeGOie", "block": "{\"symbols\":[\"timeslot\",\"phsio\"],\"statements\":[[6,\"div\"],[9,\"class\",\"masthead segment bg2\"],[7],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"ui container\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"introduction\"],[7],[0,\"\\n      \"],[6,\"h1\"],[9,\"class\",\"ui inverted header\"],[7],[0,\"\\n        \"],[6,\"span\"],[9,\"class\",\"library\"],[9,\"style\",\"font-size: 1.25em\"],[7],[0,\"Book appointments\"],[8],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"],[8],[0,\"\\n\\n\"],[6,\"br\"],[7],[8],[6,\"br\"],[7],[8],[0,\"\\n\"],[6,\"link\"],[9,\"integrity\",\"\"],[9,\"rel\",\"stylesheet\"],[9,\"href\",\"/assets/css/form-style.css\"],[7],[8],[0,\" \"],[2,\" Resource style \"],[0,\"\\n\\n\\n\"],[6,\"form\"],[9,\"class\",\"cd-form floating-labels\"],[9,\"style\",\"padding-right: 10em; padding-left: 10em\"],[3,\"action\",[[19,0,[]],\"save\"],[[\"on\"],[\"submit\"]]],[7],[0,\"\\n\\n\\n  \"],[6,\"label\"],[9,\"class\",\"cd-label\"],[7],[0,\"Select Physiotherapist\"],[8],[0,\"\\n  \"],[6,\"p\"],[9,\"class\",\"cd-select icon\"],[7],[0,\"\\n    \"],[6,\"select\"],[9,\"class\",\"people\"],[10,\"value\",[18,\"selectphysio\"],null],[10,\"onchange\",[25,\"action\",[[19,0,[]],\"updateValue\"],[[\"value\"],[\"target.value\"]]],null],[7],[0,\"\\n      \"],[6,\"option\"],[9,\"value\",\"\"],[9,\"selected\",\"\"],[9,\"disabled\",\"\"],[9,\"hidden\",\"\"],[7],[0,\"Select Physiotherapist\"],[8],[0,\"\\n\"],[4,\"each\",[[20,[\"getphysio\"]]],null,{\"statements\":[[0,\"        \"],[6,\"option\"],[10,\"value\",[19,2,[\"id\"]],null],[7],[0,\"\\n          \"],[1,[19,2,[\"givenName\"]],false],[0,\"\\n        \"],[8],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\\n\\n\"],[8],[0,\"\\n\"],[6,\"br\"],[7],[8],[6,\"br\"],[7],[8],[0,\"\\n\"],[1,[25,\"as-calendar\",null,[[\"title\",\"occurrences\",\"defaultTimeZoneQuery\",\"dayStartingTime\",\"dayEndingTime\",\"timeSlotDuration\",\"onAddOccurrence\",\"onUpdateOccurrence\",\"onRemoveOccurrence\"],[\"Schedule\",[20,[\"occurrences\"]],\"Toronto|New York\",\"8:00\",\"20:00\",\"00:30\",[25,\"action\",[[19,0,[]],\"calendarAddOccurrence\"],null],[25,\"action\",[[19,0,[]],\"calendarUpdateOccurrence\"],null],[25,\"action\",[[19,0,[]],\"calendarRemoveOccurrence\"],null]]]],false],[0,\"\\n\\n\\n\\n\"],[4,\"ui-modal\",null,[[\"name\",\"class\"],[[20,[\"modalName\"]],\"bk\"]],{\"statements\":[[0,\"  \"],[6,\"form\"],[9,\"class\",\"cd-form floating-labels\"],[7],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"scrolling content\"],[7],[0,\"\\n\\n      \"],[6,\"fieldset\"],[7],[0,\"\\n        \"],[6,\"legend\"],[7],[0,\"Book Appointment\"],[8],[0,\"\\n        \"],[6,\"label\"],[9,\"class\",\"cd-label\"],[7],[0,\" Physiotherapist\"],[8],[0,\"\\n        \"],[6,\"p\"],[7],[1,[18,\"familyName\"],false],[0,\" \"],[1,[18,\"givenName\"],false],[8],[0,\"\\n        \"],[6,\"br\"],[7],[8],[0,\"\\n\\n        \"],[6,\"label\"],[9,\"class\",\"cd-label\"],[7],[0,\"Select Type\"],[8],[0,\"\\n        \"],[6,\"p\"],[9,\"class\",\"cd-select icon\"],[7],[0,\"\\n          \"],[6,\"select\"],[9,\"class\",\"selectedAppointment\"],[10,\"value\",[18,\"selectAppointmentType\"],null],[10,\"onchange\",[25,\"action\",[[19,0,[]],\"updateTime\"],[[\"value\"],[\"target.value\"]]],null],[7],[0,\"\\n            \"],[6,\"option\"],[9,\"value\",\"\"],[9,\"selected\",\"\"],[9,\"disabled\",\"\"],[9,\"hidden\",\"\"],[7],[0,\"Select type\"],[8],[0,\"\\n            \"],[6,\"option\"],[9,\"value\",\"i\"],[7],[0,\"\\n              Initial Assessment\\n            \"],[8],[0,\"\\n            \"],[6,\"option\"],[9,\"value\",\"t\"],[7],[0,\"\\n              Treatment\\n            \"],[8],[0,\"\\n\\n          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\\n\\n        \"],[6,\"div\"],[9,\"class\",\"icon\"],[7],[0,\"\\n          \"],[6,\"label\"],[9,\"class\",\"cd-label\"],[7],[0,\"Reason\"],[8],[0,\"\\n          \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"value\"],[\"star\",\"text\",[20,[\"Reason\"]]]]],false],[0,\"\\n        \"],[8],[0,\"\\n\\n        \"],[6,\"div\"],[9,\"class\",\"icon\"],[7],[0,\"\\n          \"],[6,\"label\"],[9,\"class\",\"cd-label\"],[7],[0,\"Other\"],[8],[0,\"\\n          \"],[1,[25,\"input\",null,[[\"class\",\"type\",\"value\"],[\"user\",\"text\",[20,[\"Other\"]]]]],false],[0,\"\\n        \"],[8],[0,\"\\n\\n        \"],[6,\"label\"],[9,\"class\",\"cd-label\"],[7],[0,\"Select Time Slot\"],[8],[0,\"\\n        \"],[6,\"p\"],[9,\"class\",\"cd-select icon\"],[7],[0,\"\\n          \"],[6,\"select\"],[9,\"class\",\"people\"],[10,\"value\",[18,\"selectedTime\"],null],[10,\"onchange\",[25,\"action\",[[19,0,[]],\"setselectedtime\"],[[\"value\"],[\"target.value\"]]],null],[7],[0,\"\\n            \"],[6,\"option\"],[9,\"value\",\"\"],[9,\"selected\",\"\"],[9,\"disabled\",\"\"],[9,\"hidden\",\"\"],[7],[0,\"Select TimeSlot\"],[8],[0,\"\\n\"],[4,\"each\",[[20,[\"timeSlots\"]]],null,{\"statements\":[[0,\"              \"],[6,\"option\"],[10,\"value\",[19,1,[\"time\"]],null],[7],[0,\"\\n                \"],[1,[19,1,[\"value\"]],false],[0,\"\\n              \"],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"          \"],[8],[0,\"\\n        \"],[8],[0,\"\\n\\n        \"],[6,\"div\"],[7],[0,\"\\n          \"],[6,\"button\"],[9,\"class\",\"ui fluid negative button\"],[3,\"action\",[[19,0,[]],\"cancel_appointment\"]],[7],[0,\"Cancel\"],[8],[0,\"\\n          \"],[6,\"button\"],[9,\"class\",\"ui fluid positive button\"],[3,\"action\",[[19,0,[]],\"book_appointment\"]],[7],[0,\"Submit\"],[8],[0,\"\\n        \"],[8],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/components/client-appointment.hbs" } });
});
...
define("self-start-front-end/templates/components/display-assessment", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "tiq4+BES", "block": "{\"symbols\":[\"q\",\"index\"],\"statements\":[[6,\"p\"],[9,\"style\",\"cursor: pointer; \"],[9,\"title\",\"View Answers\"],[3,\"action\",[[19,0,[]],\"openModal\"]],[7],[0,\"\\n  \"],[6,\"img\"],[9,\"src\",\"/assets/images/eye-19.svg\"],[7],[8],[0,\"\\n\"],[8],[0,\"\\n\\n\"],[4,\"ui-modal\",null,[[\"name\",\"class\"],[[20,[\"modalName\"]],[20,[\"modalName\"]]]],{\"statements\":[[0,\"      \"],[6,\"i\"],[9,\"class\",\"close icon\"],[7],[8],[0,\"\\n  \"],[6,\"link\"],[9,\"integrity\",\"\"],[9,\"rel\",\"stylesheet\"],[10,\"href\",[26,[[18,\"rootURL\"],\"../assets/css/form-style.css\"]]],[7],[8],[0,\" \"],[2,\" Resource style \"],[0,\"\\n\\n\\n  \"],[6,\"div\"],[9,\"class\",\"header\"],[7],[0,\"Form View\"],[8],[0,\"\\n  \"],[6,\"div\"],[9,\"class\",\"scrolling content\"],[7],[0,\"\\n\\n    \"],[6,\"form\"],[9,\"id\",\"edit\"],[9,\"class\",\"cd-form floating-labels\"],[7],[0,\"\\n\\n\"],[4,\"each\",[[20,[\"orders\"]]],null,{\"statements\":[[0,\"      \"],[1,[25,\"display-answers\",null,[[\"question\",\"assessment\",\"qNumber\",\"assessid\"],[[19,1,[\"question\"]],[20,[\"assessment\"]],[19,2,[]],[20,[\"assessment\",\"id\"]]]]],false],[0,\"\\n\"]],\"parameters\":[1,2]},null],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\\n\\n\\n\\n\\n\"],[0,\"      \\n      \\n\\n   \\n\\n\"],[0,\"  \\n\\n\\n\"]],\"parameters\":[]},null],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/components/display-assessment.hbs" } });
});
...
define("self-start-front-end/templates/practitioner/assessment-display", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "FTxsyw5T", "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[1,[25,\"display-assessment\",null,[[\"id\"],[[20,[\"id\"]]]]],false],[0,\"\\n\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/practitioner/assessment-display.hbs" } });
});
...
define("self-start-front-end/templates/practitioner/new-rehabplans", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "ojHX8Y1+", "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[1,[18,\"rehab-plan\"],false],[0,\"\\n\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/practitioner/new-rehabplans.hbs" } });
});
...
define("self-start-front-end/templates/practitioner/rehabplans", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "Jrx5nAzT", "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[1,[18,\"rehab-table\"],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/practitioner/rehabplans.hbs" } });
});
...
if (!runningTests) {
  require("self-start-front-end/app")["default"].create({"name":"self-start-front-end","version":"0.0.0+3be2b721"});
}
