  ...
  exports.default = Ember.Component.extend({
    ...
    actions: {
      ...
      submit: function submit() {
        ...
        // this.set("actionSteps", []);
        if (this.get('flagAdd') === true) this.set('flagAdd', false);else this.set('flagAdd', true);
    ...
    actions: {
      ...
      submit: function submit() {
        ...
        this.get('DS').findRecord('patient', this.get('pateintsData').id).then(function (rec) {
          ...
          rec.set('streetName', _this2.get('pateintsData.streetName'));
          rec.set('streetNumber', _this2.get('pateintsData.streetNumber'));
          rec.set('apartment', _this2.get('pateintsData.apartment'));
          ...
          rec.set('city', _this2.get('pateintsData.city'));
          rec.set('healthCardNumber', _this2.get('pateintsData.healthCardNumber'));
          rec.set('gender', _this2.get('gender'));
          rec.set('dateOfBirth', new Date(_this2.get('selectedDate')));
          rec.set('phoneNumber', _this2.get('pateintsData.phoneNumber'));
          rec.set('postalCode', _this2.get('pateintsData.postalCode'));
...
define('self-start-front-end/components/manage-admin-accounts', ['exports'], function (exports) {
  ...
  exports.default = Ember.Component.extend({
    ...
    modelAttributes: [{ 'key': 'givenName', 'name': 'First Name', 'dir': 'asc', 'class': 'left aligned three wide column' }, { 'key': 'familyName', 'name': 'Last Name', 'dir': '', 'class': 'left aligned three wide column' }, { 'key': 'dateOfBirth', 'name': 'Date of Birth', 'dir': '', 'class': 'left aligned threees wide column' },
...
define('self-start-front-end/components/manage-exercises', ['exports'], function (exports) {
  ...
  exports.default = Ember.Component.extend({
    ...
    modelAttributes: [{ 'key': 'name', 'name': 'Name', 'dir': '', 'class': 'left aligned seven wide column' }, { 'key': 'sets', 'name': 'Sets', 'dir': 'asc', 'class': 'left aligned two wide column' }, { 'key': 'reps', 'name': 'Reps', 'dir': '', 'class': 'left aligned two wide column' }, { 'key': 'duration', 'name': 'Duration', 'dir': '', 'class': 'left aligned three wide column' }],
