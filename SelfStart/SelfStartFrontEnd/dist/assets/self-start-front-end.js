    ...
    actions: {
      ...
      submit: function submit() {
        ...
        this.queue.forEach(function (file) {
          ...
          _this2.get('DS').findRecord('exercise', _this2.get('exercisesData').id).then(function (rec) {
        ...
        this.get('DS').findRecord('exercise', this.get('exercisesData').id).then(function (rec) {
          rec.set('name', _this2.get('exercisesData.name'));
          rec.set('description', _this2.get('exercisesData.description'));
          rec.set('authorName', '');
          rec.set('sets', _this2.get('exercisesData.sets'));
          rec.set('reps', _this2.get('exercisesData.reps'));
          rec.set('actionSteps', _this2.get('exercisesData.actionSteps'));
          rec.set('duration', _this2.get('exercisesData.duration'));
          rec.set('multimediaURL', _this2.get('exercisesData.multimediaURL'));
          ...
          rec.save().then(function () {
            ...
            _this2.queue.clear();
            if (_this2.get('flagEdit') === true) _this2.set('flagEdit', false);else _this2.set('flagEdit', true);
            $('.ui.' + _this2.get('modalName') + '.modal').modal('hide');
          });
        });
      },
