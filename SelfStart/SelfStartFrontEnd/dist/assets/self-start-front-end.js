      ...
      openModal: function openModal() {
        ...
        Ember.$('.ui.addRehab.modal').modal({
          ...
          onApprove: function onApprove() {
            ...
            var rehabplan = _this.get('DS').createRecord('rehabilitationplan', {
              planName: _this.get('Name'),
              physioID: _this.get('authorName'),
              description: _this.get('description'),
              goal: _this.get('goal'),
              timeToComplete: _this.get('ttc')
        ...
        Ember.$('.ui.' + this.get('modalName') + '.modal').modal({
          ...
          onApprove: function onApprove() {
            _this.get('DS').findRecord('rehabilitationplan', _this.get('ID')).then(function (rec) {
              ...
              rec.set('timeToComplete', _this.get('ttc'));
              // rec.set('exercises', this.get('exercises'));
              // rec.set('assessmentTests', this.get('assessmentTests'));
              rec.save().then(function () {
                return true;
...
define('self-start-front-end/components/view-exercise', ['exports'], function (exports) {
  'use strict';
...
define("self-start-front-end/templates/components/view-exercise", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "6ttBkM+q", "block": "{\"symbols\":[\"exercise\"],\"statements\":[[6,\"div\"],[9,\"class\",\"ui bottom attached button\"],[7],[0,\"\\n  \"],[6,\"i\"],[9,\"class\",\"add icon\"],[7],[8],[0,\"\\n  Add Exercise\\n\"],[8],[0,\"\\n\\n\"],[4,\"ui-modal\",null,[[\"name\",\"class\"],[\"viewExercise\",\"viewExercise\"]],{\"statements\":[[0,\"\\n\"],[4,\"each\",[[20,[\"exercises\"]]],null,{\"statements\":[[0,\"      \"],[6,\"li\"],[7],[1,[19,1,[\"name\"]],false],[8],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"\\n  \"],[6,\"form\"],[9,\"class\",\"ui form\"],[7],[0,\"\\n  \"],[6,\"br\"],[7],[8],[6,\"br\"],[7],[8],[0,\"\\n    \"],[6,\"div\"],[9,\"class\",\"actions\"],[7],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"ui black deny button\"],[7],[0,\"\\n        Cancel\\n      \"],[8],[0,\"\\n      \"],[6,\"div\"],[9,\"class\",\"ui positive right labeled icon button\"],[7],[0,\"\\n        Save\\n        \"],[6,\"i\"],[9,\"class\",\"checkmark icon\"],[7],[8],[0,\"\\n      \"],[8],[0,\"\\n    \"],[8],[0,\"\\n  \"],[8],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "self-start-front-end/templates/components/view-exercise.hbs" } });
});
