...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n9:16 - \'Ember\' is not defined. (no-undef)\n10:18 - \'Ember\' is not defined. (no-undef)\n11:16 - \'Ember\' is not defined. (no-undef)\n16:3 - Duplicate key \'paid\'. (no-dupe-keys)\n24:14 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n35:23 - \'Ember\' is not defined. (no-undef)\n52:5 - Unexpected console statement. (no-console)\n53:5 - Unexpected console statement. (no-console)\n54:5 - Unexpected console statement. (no-console)\n63:7 - Unexpected console statement. (no-console)\n206:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n216:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n217:7 - Unexpected console statement. (no-console)\n231:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n237:31 - \'Ember\' is not defined. (no-undef)\n246:11 - Unexpected console statement. (no-console)\n261:52 - \'Ember\' is not defined. (no-undef)\n281:29 - \'Ember\' is not defined. (no-undef)\n295:42 - \'Ember\' is not defined. (no-undef)\n312:7 - Unexpected console statement. (no-console)\n321:30 - \'Ember\' is not defined. (no-undef)\n331:9 - Unexpected console statement. (no-console)\n332:9 - Unexpected console statement. (no-console)\n333:9 - Unexpected console statement. (no-console)\n344:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n346:7 - Unexpected console statement. (no-console)\n357:7 - Unexpected console statement. (no-console)\n363:9 - Unexpected console statement. (no-console)\n365:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n367:39 - \'ba\' is defined but never used. (no-unused-vars)\n382:19 - Unexpected console statement. (no-console)\n392:19 - Unexpected console statement. (no-console)\n403:19 - Unexpected console statement. (no-console)');
  });
