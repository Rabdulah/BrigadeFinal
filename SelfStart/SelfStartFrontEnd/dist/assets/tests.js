...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n9:16 - \'Ember\' is not defined. (no-undef)\n10:18 - \'Ember\' is not defined. (no-undef)\n11:16 - \'Ember\' is not defined. (no-undef)\n16:3 - Duplicate key \'paid\'. (no-dupe-keys)\n24:14 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n35:23 - \'Ember\' is not defined. (no-undef)\n52:5 - Unexpected console statement. (no-console)\n53:5 - Unexpected console statement. (no-console)\n54:5 - Unexpected console statement. (no-console)\n70:11 - \'Ember\' is not defined. (no-undef)\n77:7 - Unexpected console statement. (no-console)\n141:7 - Unexpected console statement. (no-console)\n152:7 - Unexpected console statement. (no-console)\n164:7 - Unexpected console statement. (no-console)\n282:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n292:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n293:7 - Unexpected console statement. (no-console)\n307:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n313:31 - \'Ember\' is not defined. (no-undef)\n322:11 - Unexpected console statement. (no-console)\n337:52 - \'Ember\' is not defined. (no-undef)\n357:29 - \'Ember\' is not defined. (no-undef)\n371:42 - \'Ember\' is not defined. (no-undef)\n388:7 - Unexpected console statement. (no-console)\n397:30 - \'Ember\' is not defined. (no-undef)\n413:7 - \'Ember\' is not defined. (no-undef)\n430:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n432:7 - Unexpected console statement. (no-console)\n443:7 - Unexpected console statement. (no-console)\n449:9 - Unexpected console statement. (no-console)\n451:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n453:39 - \'ba\' is defined but never used. (no-unused-vars)\n468:19 - Unexpected console statement. (no-console)\n478:19 - Unexpected console statement. (no-console)\n489:19 - Unexpected console statement. (no-console)');
  });
  ...
  QUnit.test('components/client-questions.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/client-questions.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('components/payment-button-package-additional.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/payment-button-package-additional.js should pass ESLint\n\n17:7 - Unexpected console statement. (no-console)\n25:5 - \'paypal\' is not defined. (no-undef)\n68:17 - \'length2\' is assigned a value but never used. (no-unused-vars)\n71:17 - \'temp2\' is assigned a value but never used. (no-unused-vars)\n75:13 - Unexpected console statement. (no-console)\n76:30 - \'obj\' is defined but never used. (no-unused-vars)\n79:17 - \'Ember\' is not defined. (no-undef)\n80:17 - \'Ember\' is not defined. (no-undef)\n81:17 - \'Ember\' is not defined. (no-undef)\n98:17 - \'Ember\' is not defined. (no-undef)\n99:17 - Unexpected console statement. (no-console)\n103:17 - Unexpected console statement. (no-console)');
  });
  ...
  QUnit.test('components/user-info.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/user-info.js should pass ESLint\n\n64:14 - \'Ember\' is not defined. (no-undef)\n110:7 - Unexpected console statement. (no-console)\n136:7 - Unexpected console statement. (no-console)\n137:7 - Unexpected console statement. (no-console)\n139:9 - Unexpected console statement. (no-console)\n140:9 - Unexpected console statement. (no-console)\n158:9 - Unexpected console statement. (no-console)\n160:11 - Unexpected console statement. (no-console)\n161:11 - Unexpected console statement. (no-console)\n163:13 - Unexpected console statement. (no-console)\n165:15 - Unexpected console statement. (no-console)\n167:44 - \'o\' is defined but never used. (no-unused-vars)\n169:13 - Unexpected console statement. (no-console)\n175:17 - \'ans\' is assigned a value but never used. (no-unused-vars)\n237:7 - Unexpected console statement. (no-console)');
  });

  QUnit.test('components/user-login.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/user-login.js should pass ESLint\n\n4:10 - \'computed\' is defined but never used. (no-unused-vars)\n47:11 - Unexpected console statement. (no-console)\n48:11 - Unexpected console statement. (no-console)\n64:13 - Unexpected console statement. (no-console)\n65:13 - Unexpected console statement. (no-console)\n96:9 - Unexpected console statement. (no-console)\n118:25 - \'userName\' is assigned a value but never used. (no-unused-vars)\n120:21 - Unexpected console statement. (no-console)\n121:21 - Unexpected console statement. (no-console)\n123:23 - Unexpected console statement. (no-console)\n127:23 - Unexpected console statement. (no-console)\n132:25 - Unexpected console statement. (no-console)\n147:17 - Unexpected console statement. (no-console)');
  });
  ...
  QUnit.test('routes/practitioner/ask-a-therapist.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/practitioner/ask-a-therapist.js should pass ESLint\n\n');
  });
...
define('self-start-front-end/tests/integration/components/client-questions-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';

  (0, _emberQunit.moduleForComponent)('client-questions', 'Integration | Component | client questions', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      "id": "fWJ2+RpY",
      "block": "{\"symbols\":[],\"statements\":[[1,[18,\"client-questions\"],false]],\"hasEval\":false}",
      "meta": {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      "id": "fKbgg317",
      "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"client-questions\",null,null,{\"statements\":[[0,\"      template block text\\n\"]],\"parameters\":[]},null],[0,\"  \"]],\"hasEval\":false}",
      "meta": {}
    }));
...
define('self-start-front-end/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('integration/components/client-questions-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/client-questions-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/practitioner/ask-a-therapist-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/practitioner/ask-a-therapist-test.js should pass ESLint\n\n');
  });
...
define('self-start-front-end/tests/unit/routes/practitioner/ask-a-therapist-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';

  (0, _emberQunit.moduleFor)('route:practitioner/ask-a-therapist', 'Unit | Route | practitioner/ask a therapist', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
