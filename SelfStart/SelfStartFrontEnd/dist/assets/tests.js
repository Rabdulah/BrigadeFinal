...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n9:16 - \'Ember\' is not defined. (no-undef)\n10:18 - \'Ember\' is not defined. (no-undef)\n11:16 - \'Ember\' is not defined. (no-undef)\n16:3 - Duplicate key \'paid\'. (no-dupe-keys)\n24:14 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n35:23 - \'Ember\' is not defined. (no-undef)\n52:5 - Unexpected console statement. (no-console)\n53:5 - Unexpected console statement. (no-console)\n69:11 - \'Ember\' is not defined. (no-undef)\n76:7 - Unexpected console statement. (no-console)\n283:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n293:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n294:7 - Unexpected console statement. (no-console)\n308:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n314:31 - \'Ember\' is not defined. (no-undef)\n323:11 - Unexpected console statement. (no-console)\n338:52 - \'Ember\' is not defined. (no-undef)\n358:29 - \'Ember\' is not defined. (no-undef)\n372:42 - \'Ember\' is not defined. (no-undef)\n389:7 - Unexpected console statement. (no-console)\n398:30 - \'Ember\' is not defined. (no-undef)\n414:7 - \'Ember\' is not defined. (no-undef)\n431:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n433:7 - Unexpected console statement. (no-console)\n444:7 - Unexpected console statement. (no-console)\n450:9 - Unexpected console statement. (no-console)\n452:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n454:39 - \'ba\' is defined but never used. (no-unused-vars)\n469:19 - Unexpected console statement. (no-console)\n479:19 - Unexpected console statement. (no-console)\n490:19 - Unexpected console statement. (no-console)');
  });
