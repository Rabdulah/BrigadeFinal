...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n9:16 - \'Ember\' is not defined. (no-undef)\n10:18 - \'Ember\' is not defined. (no-undef)\n11:16 - \'Ember\' is not defined. (no-undef)\n16:3 - Duplicate key \'paid\'. (no-dupe-keys)\n24:14 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n35:23 - \'Ember\' is not defined. (no-undef)\n52:5 - Unexpected console statement. (no-console)\n53:5 - Unexpected console statement. (no-console)\n54:5 - Unexpected console statement. (no-console)\n70:11 - \'Ember\' is not defined. (no-undef)\n77:7 - Unexpected console statement. (no-console)\n133:7 - Unexpected console statement. (no-console)\n144:7 - Unexpected console statement. (no-console)\n156:7 - Unexpected console statement. (no-console)\n266:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n276:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n277:7 - Unexpected console statement. (no-console)\n291:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n297:31 - \'Ember\' is not defined. (no-undef)\n306:11 - Unexpected console statement. (no-console)\n321:52 - \'Ember\' is not defined. (no-undef)\n341:29 - \'Ember\' is not defined. (no-undef)\n355:42 - \'Ember\' is not defined. (no-undef)\n372:7 - Unexpected console statement. (no-console)\n381:30 - \'Ember\' is not defined. (no-undef)\n397:7 - \'Ember\' is not defined. (no-undef)\n414:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n416:7 - Unexpected console statement. (no-console)\n427:7 - Unexpected console statement. (no-console)\n433:9 - Unexpected console statement. (no-console)\n435:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n437:39 - \'ba\' is defined but never used. (no-unused-vars)\n452:19 - Unexpected console statement. (no-console)\n462:19 - Unexpected console statement. (no-console)\n473:19 - Unexpected console statement. (no-console)');
  });
