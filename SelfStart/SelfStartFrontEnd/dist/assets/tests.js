...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n9:16 - \'Ember\' is not defined. (no-undef)\n10:18 - \'Ember\' is not defined. (no-undef)\n11:16 - \'Ember\' is not defined. (no-undef)\n16:3 - Duplicate key \'paid\'. (no-dupe-keys)\n24:14 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n35:23 - \'Ember\' is not defined. (no-undef)\n52:5 - Unexpected console statement. (no-console)\n53:5 - Unexpected console statement. (no-console)\n54:5 - Unexpected console statement. (no-console)\n70:11 - \'Ember\' is not defined. (no-undef)\n77:7 - Unexpected console statement. (no-console)\n141:7 - Unexpected console statement. (no-console)\n152:7 - Unexpected console statement. (no-console)\n168:7 - Unexpected console statement. (no-console)\n286:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n296:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n297:7 - Unexpected console statement. (no-console)\n311:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n317:31 - \'Ember\' is not defined. (no-undef)\n326:11 - Unexpected console statement. (no-console)\n341:52 - \'Ember\' is not defined. (no-undef)\n361:29 - \'Ember\' is not defined. (no-undef)\n375:42 - \'Ember\' is not defined. (no-undef)\n392:7 - Unexpected console statement. (no-console)\n401:30 - \'Ember\' is not defined. (no-undef)\n417:7 - \'Ember\' is not defined. (no-undef)\n434:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n436:7 - Unexpected console statement. (no-console)\n447:7 - Unexpected console statement. (no-console)\n453:9 - Unexpected console statement. (no-console)\n455:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n457:39 - \'ba\' is defined but never used. (no-unused-vars)\n472:19 - Unexpected console statement. (no-console)\n482:19 - Unexpected console statement. (no-console)\n493:19 - Unexpected console statement. (no-console)');
  });
