...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/view-schedule.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/view-schedule.js should pass ESLint\n\n4:8 - \'$\' is defined but never used. (no-unused-vars)\n8:16 - \'Ember\' is not defined. (no-undef)\n11:18 - \'Ember\' is not defined. (no-undef)\n12:16 - \'Ember\' is not defined. (no-undef)\n13:22 - \'Ember\' is not defined. (no-undef)\n32:23 - \'Ember\' is not defined. (no-undef)\n45:7 - Unexpected console statement. (no-console)\n48:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n49:7 - Unexpected console statement. (no-console)\n53:11 - \'isCollided\' is assigned a value but never used. (no-unused-vars)\n57:15 - \'rages\' is assigned a value but never used. (no-unused-vars)\n59:15 - \'ranges\' is not defined. (no-undef)\n59:63 - \'ranges\' is not defined. (no-undef)\n60:13 - Unexpected console statement. (no-console)\n60:25 - \'collided\' is not defined. (no-undef)\n75:7 - Unexpected console statement. (no-console)\n76:7 - Unexpected console statement. (no-console)\n85:31 - \'Ember\' is not defined. (no-undef)\n86:31 - \'Ember\' is not defined. (no-undef)\n104:33 - \'Ember\' is not defined. (no-undef)\n117:28 - \'Ember\' is not defined. (no-undef)\n179:11 - Unexpected console statement. (no-console)');
  });
