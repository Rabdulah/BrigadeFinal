...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n11:16 - \'Ember\' is not defined. (no-undef)\n12:18 - \'Ember\' is not defined. (no-undef)\n13:16 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n34:14 - \'Ember\' is not defined. (no-undef)\n40:23 - \'Ember\' is not defined. (no-undef)\n59:5 - Unexpected console statement. (no-console)\n64:7 - Unexpected console statement. (no-console)\n197:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n207:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n208:7 - Unexpected console statement. (no-console)\n222:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n228:31 - \'Ember\' is not defined. (no-undef)\n237:11 - Unexpected console statement. (no-console)\n252:52 - \'Ember\' is not defined. (no-undef)\n272:29 - \'Ember\' is not defined. (no-undef)\n286:42 - \'Ember\' is not defined. (no-undef)\n303:7 - Unexpected console statement. (no-console)\n312:30 - \'Ember\' is not defined. (no-undef)\n323:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n325:7 - Unexpected console statement. (no-console)\n336:7 - Unexpected console statement. (no-console)\n350:9 - Unexpected console statement. (no-console)\n352:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n354:39 - \'ba\' is defined but never used. (no-unused-vars)\n369:19 - Unexpected console statement. (no-console)\n379:19 - Unexpected console statement. (no-console)\n390:19 - Unexpected console statement. (no-console)');
  });
