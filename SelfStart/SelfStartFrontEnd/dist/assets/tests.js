...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n11:16 - \'Ember\' is not defined. (no-undef)\n12:18 - \'Ember\' is not defined. (no-undef)\n13:16 - \'Ember\' is not defined. (no-undef)\n29:14 - \'Ember\' is not defined. (no-undef)\n34:14 - \'Ember\' is not defined. (no-undef)\n40:23 - \'Ember\' is not defined. (no-undef)\n59:5 - Unexpected console statement. (no-console)\n64:7 - Unexpected console statement. (no-console)\n192:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n202:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n203:7 - Unexpected console statement. (no-console)\n217:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n223:31 - \'Ember\' is not defined. (no-undef)\n243:52 - \'Ember\' is not defined. (no-undef)\n263:29 - \'Ember\' is not defined. (no-undef)\n277:42 - \'Ember\' is not defined. (no-undef)\n294:7 - Unexpected console statement. (no-console)\n303:30 - \'Ember\' is not defined. (no-undef)\n314:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n323:9 - Unexpected console statement. (no-console)\n339:19 - Unexpected console statement. (no-console)\n349:19 - Unexpected console statement. (no-console)\n360:19 - Unexpected console statement. (no-console)');
  });
