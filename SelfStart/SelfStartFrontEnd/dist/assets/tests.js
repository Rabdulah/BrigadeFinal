...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n10:16 - \'Ember\' is not defined. (no-undef)\n11:18 - \'Ember\' is not defined. (no-undef)\n12:16 - \'Ember\' is not defined. (no-undef)\n18:14 - \'Ember\' is not defined. (no-undef)\n23:14 - \'Ember\' is not defined. (no-undef)\n43:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n53:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n54:7 - Unexpected console statement. (no-console)\n68:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n74:31 - \'Ember\' is not defined. (no-undef)\n75:31 - \'Ember\' is not defined. (no-undef)\n95:52 - \'Ember\' is not defined. (no-undef)\n114:29 - \'Ember\' is not defined. (no-undef)\n127:42 - \'Ember\' is not defined. (no-undef)\n144:7 - Unexpected console statement. (no-console)\n153:30 - \'Ember\' is not defined. (no-undef)\n164:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n172:9 - Unexpected console statement. (no-console)\n188:19 - Unexpected console statement. (no-console)\n198:19 - Unexpected console statement. (no-console)\n209:19 - Unexpected console statement. (no-console)');
  });
