...
define('self-start-front-end/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/book-appointment.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/book-appointment.js should pass ESLint\n\n11:16 - \'Ember\' is not defined. (no-undef)\n12:18 - \'Ember\' is not defined. (no-undef)\n13:16 - \'Ember\' is not defined. (no-undef)\n19:14 - \'Ember\' is not defined. (no-undef)\n24:14 - \'Ember\' is not defined. (no-undef)\n48:5 - Unexpected console statement. (no-console)\n153:37 - \'occurrence\' is defined but never used. (no-unused-vars)\n163:64 - \'isPreview\' is defined but never used. (no-unused-vars)\n164:7 - Unexpected console statement. (no-console)\n178:40 - \'occurrence\' is defined but never used. (no-unused-vars)\n184:31 - \'Ember\' is not defined. (no-undef)\n193:11 - Unexpected console statement. (no-console)\n208:52 - \'Ember\' is not defined. (no-undef)\n228:29 - \'Ember\' is not defined. (no-undef)\n242:42 - \'Ember\' is not defined. (no-undef)\n259:7 - Unexpected console statement. (no-console)\n268:30 - \'Ember\' is not defined. (no-undef)\n279:11 - \'physio\' is assigned a value but never used. (no-unused-vars)\n281:7 - Unexpected console statement. (no-console)\n292:7 - Unexpected console statement. (no-console)\n306:9 - Unexpected console statement. (no-console)\n308:13 - \'a\' is assigned a value but never used. (no-unused-vars)\n310:39 - \'ba\' is defined but never used. (no-unused-vars)\n325:19 - Unexpected console statement. (no-console)\n335:19 - Unexpected console statement. (no-console)\n346:19 - Unexpected console statement. (no-console)');
  });
